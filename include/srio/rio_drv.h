...
extern int __rio_local_read_config_32(struct rio_mport *port, UINT32 offset,
				      UINT32 * data);
extern int __rio_local_write_config_32(struct rio_mport *port, UINT32 offset,
				       UINT32 data);
extern int __rio_local_read_config_16(struct rio_mport *port, UINT32 offset,
				      UINT16 * data);
extern int __rio_local_write_config_16(struct rio_mport *port, UINT32 offset,
				       UINT16 data);
extern int __rio_local_read_config_8(struct rio_mport *port, UINT32 offset,
				     UINT8 * data);
extern int __rio_local_write_config_8(struct rio_mport *port, UINT32 offset,
				      UINT8 data);

extern int rio_mport_read_config_32(struct rio_mport *port, UINT16 destid,
				    UINT8 hopcount, UINT32 offset, UINT32 * data);
extern int rio_mport_write_config_32(struct rio_mport *port, UINT16 destid,
				     UINT8 hopcount, UINT32 offset, UINT32 data);
extern int rio_mport_read_config_16(struct rio_mport *port, UINT16 destid,
				    UINT8 hopcount, UINT32 offset, UINT16 * data);
extern int rio_mport_write_config_16(struct rio_mport *port, UINT16 destid,
				     UINT8 hopcount, UINT32 offset, UINT16 data);
extern int rio_mport_read_config_8(struct rio_mport *port, UINT16 destid,
				   UINT8 hopcount, UINT32 offset, UINT8 * data);
extern int rio_mport_write_config_8(struct rio_mport *port, UINT16 destid,
				    UINT8 hopcount, UINT32 offset, UINT8 data);
 ...
 */
static inline int rio_local_read_config_32(struct rio_mport *port, UINT32 offset,
					   UINT32 * data)
{
 ...
 * device's configuration space.
 */
static inline int rio_local_write_config_32(struct rio_mport *port, UINT32 offset,
					    UINT32 data)
{
 ...
 * device's configuration space.
 */
static inline int rio_local_read_config_16(struct rio_mport *port, UINT32 offset,
					   UINT16 * data)
{
...
static inline int rio_local_write_config_16(struct rio_mport *port, UINT32 offset,
					    UINT16 data)
{
 ...
 * device's configuration space.
 */
static inline int rio_local_read_config_8(struct rio_mport *port, UINT32 offset,
					  UINT8 * data)
{
 ...
 * device's configuration space.
 */
static inline int rio_local_write_config_8(struct rio_mport *port, UINT32 offset,
					   UINT8 data)
{
 ...
 */
static inline int rio_read_config_32(struct rio_dev *rdev, UINT32 offset,
				     UINT32 * data)
{
 ...
 * RIO device's configuration space.
 */
static inline int rio_write_config_32(struct rio_dev *rdev, UINT32 offset,
				      UINT32 data)
{
 ...
 * RIO device's configuration space.
 */
static inline int rio_read_config_16(struct rio_dev *rdev, UINT32 offset,
				     UINT16 * data)
{
 ...
 * RIO device's configuration space.
 */
static inline int rio_write_config_16(struct rio_dev *rdev, UINT32 offset,
				      UINT16 data)
{
 ...
 * RIO device's configuration space.
 */
static inline int rio_read_config_8(struct rio_dev *rdev, UINT32 offset, UINT8 * data)
{
 ...
 * RIO device's configuration space.
 */
static inline int rio_write_config_8(struct rio_dev *rdev, UINT32 offset, UINT8 data)
{
	return rio_mport_write_config_8(rdev->net->hport, rdev->destid,
					rdev->hopcount, offset, data);
};

extern int rio_mport_send_doorbell(struct rio_mport *mport, UINT16 destid,
				   UINT16 data);
 ...
 */
static inline int rio_send_doorbell(struct rio_dev *rdev, UINT16 data)
{
 ...
 */
static inline void rio_init_dbell_res(struct resource *res, UINT16 start, UINT16 end)
{
	memset(res, 0, sizeof(struct resource));
	res->start = start;
	res->end = end;
...
#endif
/* Doorbell management */
extern int rio_request_inb_dbell(struct rio_mport *, void *, UINT16, UINT16,
				 void (*)(struct rio_mport *, void *, UINT16, UINT16, UINT16));
extern int rio_release_inb_dbell(struct rio_mport *, UINT16, UINT16);
extern struct resource *rio_request_outb_dbell(struct rio_dev *, UINT16, UINT16);
...
extern void rio_get_outb_npref_asinfo( struct rio_mport *mport,UINT64 *addr, UINT64 *size );
extern void rio_get_outb_pref_asinfo( struct rio_mport *mport,UINT64 *addr, UINT64 *size );

enum rioTxferFlags{
	RIO_NREAD = 0x1,
	RIO_MAINTENANCE_READ=0x2,
	RIO_NWRITE_SWRITE=0x4,
	RIO_MAINTENANCE_WRITE=0x8,
	RIO_NWRITE_RESPONSE=0x10
};

extern int rio_config_outb_zone(struct rio_mport *mport, UINT8 win, UINT8 zone, UINT16 destid,
		UINT64 rstart , UINT32 flags );
extern void rio_unmap_outb_window(struct rio_mport *mport, UINT8 win);
extern int rio_map_outb_window( struct rio_mport *mport, UINT8 win, UINT64 physaddr, UINT64 size, UINT32 rflags );
...
#else
extern struct dma_async_tx_descriptor *rio_dma_prep_slave_sg(struct rio_dev *rdev,
...
{
	//char *dev_name = "rio_dev_name";
	return (char*)rdev->dev.uc_dev_name;
...
/* Misc driver helpers */
extern UINT16 rio_local_get_device_id(struct rio_mport *port);
extern struct rio_dev *rio_get_device(UINT16 vid, UINT16 did, struct rio_dev *from);
extern struct rio_dev *rio_get_asm(UINT16 vid, UINT16 did, UINT16 asm_vid, UINT16 asm_did,
				   struct rio_dev *from);
