/*******************************************************************************
*
* Filename:	 CommandInterpreter.c
*
* Description:	lwIP Command Interpreter source file, modified for CCT CUTE.
*
* $Revision: 1.1 $
*
* $Date: 2013-09-04 12:15:21 $
*
* $Source: /home/cvs/cvsroot/CCT_BIT_2/lwip-1.4.0/lwIP_Apps/utils/CommandInterpreter.c,v $
*
...
attempted. */
#define COMMAND_INT_MAX_OUTPUT_SIZE 1
static signed char cOutputBuffer[ COMMAND_INT_MAX_OUTPUT_SIZE ];

/*-----------------------------------------------------------*/

/* Function used to register the commands, this must be called before using */
...
{
	return COMMAND_INT_MAX_OUTPUT_SIZE;
}
/*-----------------------------------------------------------*/
