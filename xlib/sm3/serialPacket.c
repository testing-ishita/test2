...
* $Revision: 1.2 $
*
* $Date: 2013-09-26 12:26:08 $
*
* $Source: /home/cvs/cvsroot/CCT_BIT_2/xlib/sm3/serialPacket.c,v $
*
...
extern UINT16 my_slot; // comes from cpci autoid
...
UINT16 wPacketSend (UINT8 bSlot, uPacket *psPkt, UINT8 bAckWait, UINT32 dTimeout)
{
...
#ifdef DEBUG_SOAK
	//sysDebugWriteString ("wPacketSend\n");
#endif
	...
	do
	{
		...
		{
#ifdef DEBUG_SOAK
			sysDebugWriteString ("wPacketSend MessagePut Timed out\n");
#endif
			return wStatus;
		}
...
#ifdef DEBUG_SOAK
	//sysDebugWriteString ("wPacketSend DONE\n");
#endif
...
static uPacket* psPacketAlloc (UINT8 bQueue)
{
	...
	{
		//DPRINT2 ("alloc %s %d", bQueue == Q_TX ? "tx" : "rx", bCount);
...
uPacket* psPacketGetQueue (UINT8 bQueue)
{
	...
	//DPRINT1("PktGetQ %s ", bQueue == Q_TX ? "tx" : "rx");
