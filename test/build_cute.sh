...
#
# $Source: /home/cvs/cvsroot/CCT_BIT_2/build_cute.sh,v $
#
...
# Usage examples:
#   ./build_cute.sh amc1x
#   ./build_cute.sh trb1x release
#   ./build_cute.sh vre1x clean
...
then
	...
	echo "    ./build_cute.sh 'boardName'";
	echo "    ./build_cute.sh 'boardName' clean";
	echo "    ./build_cute.sh 'boardName' release"
fi
