...
/*  $Header: /home/cvs/cvsroot/CCT_BIT_2/ibit/command.c,v 1.1 2013-09-04 07:27:43 chippisley Exp $
 *
 *  $Log: command.c,v $
 ...
 *  C541A141
 *
 *  Revision 1.14  2011/01/20 10:01:25  hmuneer
 *  CA01A151
 *
 *  Revision 1.13  2010/11/04 17:25:59  hchalla
 *  Added boot to bios from ibit prompt.
 *
 *  Revision 1.12  2010/05/05 15:46:13  hmuneer
 *  Cute rev 0.1
 *
 *  Revision 1.11  2010/03/31 16:25:13  hmuneer
 ...
 *
 *  Revision 1.9  2009/01/22 14:41:38  swilson
 *  Added further synonym for Help
 *
 *  Revision 1.8  2008/09/29 10:21:11  swilson
 *  Rename BIT error action commands; add call to set default to 'Halt'.
 *
 ...
 *
 *  Revision 1.5  2008/06/02 12:27:19  swilson
...
const CMD_TYPE	asCommands[] =
{
	...
	{TYPE__SWITCH,	 		"C+",		PF_CAST vConfirmOn		},
	{TYPE__SWITCH, 			"C-",		PF_CAST vConfirmOff		},
	{TYPE__SWITCH,	 		"CA+",		PF_CAST vCacheOn		},
	{TYPE__SWITCH, 			"CA-",		PF_CAST vCacheOff		},
	{TYPE__HELP, 			"HELP",		PF_CAST vHelpScreen		},
	{TYPE__HELP, 			"H",		PF_CAST vHelpScreen		},
	{TYPE__HELP, 			"?",		PF_CAST vHelpScreen		},
	{TYPE__HELP, 			"BITID",	PF_CAST vVersionInfo	},
	...
	{TYPE__DISPLAY_BYTE, 	"AB",		PF_CAST vDisplayAscii	},
	...
	{TYPE__CMOS_READ,		"NVR",		PF_CAST vNvRead			},
	{TYPE__CMOS_WRITE,		"NVW",		PF_CAST vNvWrite		},
	{TYPE__PCI_SCAN,	 	"PS",		PF_CAST vPciScan		},
	{TYPE__PCI_BRIDGE_SCAN,	"BS",		PF_CAST vPciBridgeScan	},
	{TYPE__PCI_QUERY,	 	"PQ",		PF_CAST vPciQuery		},
	...
	{TYPE__CPUID,			"CPUID",	PF_CAST vCpuid			},
	{TYPE__TEST,			"TM",		PF_CAST vTestMenu		},
	{TYPE__TEST,			"T",		PF_CAST vExecuteTest	},
	{TYPE__TEST,			"BIT",		PF_CAST vExecuteTest	},
	{TYPE__TEST,			"SUM",		PF_CAST vTestSummary	},
	{TYPE__TEST,			"Z",		PF_CAST vZeroCounters	},
	{TYPE__TEST,			"BEA_HALT",	PF_CAST vBeaHalt		},
	{TYPE__TEST,			"BEA_CONT",	PF_CAST vBeaContinue	},
	{TYPE__TEST,			"GPF",		PF_CAST vGpf			},
	{TYPE__UNKNOWN,		 	"",			NULL}
};
...
int iGetUserCommand (char* achCommand)
{
	int		iIndex;
	int		iKey;
	int     reprint = 0;
...
)
{
	...
	for (iIndex = 1; iIndex < iArgc; iIndex++)
	{
		...
		iType = iGetCommandType (achArgv[iIndex], &iCmdIndex);
 ...
 *
 * RETURNS: none (errors handled local to each fuction )
 */
