...
/* Version control:
*
* $Header: /home/cvs/cvsroot/CCT_BIT_2/include/devices/enxmc8619.h,v 1.5 2014-07-29 11:32:24 mgostling Exp $
*
* $Log: enxmc8619.h,v $
* Revision 1.5  2014-07-29 11:32:24  mgostling
* Use common error codes from enxmc8619.h instead of defining them locally.
*
* Revision 1.4  2014-03-27 11:52:07  mgostling
* Refactored support for EnXMC GPIO loopback tests
*
* Revision 1.3  2014-03-20 16:03:22  mgostling
* Added type definition for GPIO loopback testing
*
* Revision 1.2  2013-12-10 12:00:31  mgostling
* Added support for GPIO tests.
*
* Revision 1.1  2013-09-04 07:40:27  chippisley
* Import files into new source repository.
*
* Revision 1.3  2011/05/16 14:38:44  hchalla
* Added error code.
*
* Revision 1.2  2011/03/22 13:40:04  hchalla
* Added new defines.
*
*
*
...
#define E__ENXMC_VXSPCIE_LOOPBACK_DATA_ERROR E__BIT  + 0x08
#define E__BAD_GPIO_LOOPBACK				 E__BIT  + 0x09
#define E__BAD_DIFF_IO_LOOPBACK_DEV0		 E__BIT  + 0x0A
#define E__BAD_DIFF_IO_LOOPBACK_DEV2		 E__BIT  + 0x0B
...
typedef struct pex8619
{
	...
	volatile addr_t csr;/*pointer ot config space register*/
	volatile addr_t pciMem;
	volatile addr_t ramMem;
	volatile addr_t ramMem1;
	int active;
}ENXMC_PEX_8619_DEV_CTRL;
...
typedef struct pex8619dma
{
	...
	UINT8 function:3;/*function number*/
	UINT32 irq;/*Interrupt number*/
	volatile addr_t dmacsr;/*pointer ot config space register*/
	int active;
}ENXMC_PEX_8619_DMA_CTRL;
...
typedef struct _pex8619_gpio_signal_pairs_t
{
	UINT8 out;		// output GPIO drives input GPIO
	UINT8 in;
}ENXMC_GPIO_SIGNAL_PAIRS;

typedef struct _pex8619_gpio_loopback_info_t
{
	UINT8	plx8619Instance;
	const ENXMC_GPIO_SIGNAL_PAIRS * gpioTable;
	UINT32	dConfig1;
	UINT32	dConfig2;
	UINT32	dOutputs;
	UINT32	dInputs;
}ENXMC_GPIO_LOOPBACK_INFO;
