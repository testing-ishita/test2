...
/* Version control:
 *
 * $Header: /home/cvs/cvsroot/CCT_BIT_2/board/ppb1x.msd/SCR.c,v 1.2 2015-04-01 16:44:29 hchalla Exp $
 *
 * $Log: SCR.c,v $
...
SACReg SACRegs[] = {{"Status & Control Register 0",          0x210, 0x00, 0xF2, 0x10 },
		 	 	 	 	 	 	 	{"Status & Control Register 1",          0x211, 0x03, 0xF0, 0x20 },
		 	 	 	 	 	 	 	/*{"Status & Control Register 2",          0x212, 0x00, 0x04, 0x30 },*/ //wrmask was 0x08
									{"Status & Control Register 3",          0x213, 0x0B, 0xF4, 0x40 },
		 	 	 	 	 	 	 /*	{"CPCI Status Register",                    0x214, 0x00, 0x00, 0x50 },*/
