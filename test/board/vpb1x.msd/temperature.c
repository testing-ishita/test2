...
/* Version control:
 *
 * $Header: /home/cvs/cvsroot/CCT_BIT_2/board/vpb1x.msd/temperature.c,v 1.1 2015-02-25 17:50:45 hchalla Exp $
 *
 * $Log: temperature.c,v $
...
TEMTHRESHOLD localTempThreshold = {
							0x64,
							0x64,
							0x64
};
...
/*****************************************************************************
 * brdGetTempTresholds: returns the TEMTHRESHOLD global data structure
 * RETURNS: TEMTHRESHOLD* */
UINT32 brdGetTempTresholds(void *ptr)
{
	*((TEMTHRESHOLD**)ptr) = &localTempThreshold;
