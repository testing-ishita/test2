...
/* Version control:
 *
 * $Header: /home/cvs/cvsroot/CCT_BIT_2/board/vpb1x.msd/SCR.c,v 1.1 2015-02-25 17:50:45 hchalla Exp $
 *
 * $Log: SCR.c,v $
...
//													 		  Port    WR    RO   Error
SACReg SACRegs[] = { {"Status & Control Register 0",	      0x210, 0x00, 0x40, 0x10 },
									/* {"Status & Control Register 1",	      0x211, 0x24, 0x03, 0x20 },*/
									 {"Status & Control Register 2",	      0x212, 0x00, 0x04, 0x30 },
									 {"Status & Control Register 3",	      0x21d, 0x70, 0x0A, 0x40 },
					 {NULL,								      0x00,  0x00, 0x00, 0x00 }
				   };
/*
SACReg SACRegs[] = { {"Status & Control Register 0",	      0x210, 0x38, 0xff, 0x10 },
					 {"Status & Control Register 1",	      0x212, 0x00, 0xc0, 0x20 },
					 {"Status & Control Register 2",	      0x211, 0x00, 0x24, 0x30 },
					 {"Status & Control Register 3",	      0x21d, 0x70, 0x70, 0x40 },
					 {NULL,								      0x00,  0x00, 0x00, 0x00 }
				   };
*/
