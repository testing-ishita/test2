...
/* Version control:
 *
 * $Header: /home/cvs/cvsroot/CCT_BIT_2/board/vpb1x.msd/board_info.c,v 1.1 2015-02-25 17:50:45 hchalla Exp $
 *
 * $Log: board_info.c,v $
	...
	)
{
	...
	if(csum == cuteInfo.header_chksum)
	{
		...
		if(strcmp(cuteInfo.signature, "CUTE_CONFIGINFO") == 0)
		{
			#ifdef DEBUG
	...
	)
{
	...
	if(csum == BIOSInfo.header_chksum)
	{
		...
		if(strcmp(BIOSInfo.signature, "CUTE_BIOS_INFO_") == 0)
		{
			#ifdef DEBUG
				sysDebugWriteString (". signature:    " );
