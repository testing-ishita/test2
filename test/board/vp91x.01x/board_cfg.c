...
/* Version control:
 *
 * $Header: /home/cvs/cvsroot/CCT_BIT_2/board/vp91x.01x/board_cfg.c,v 1.3 2015-02-27 13:22:10 mgostling Exp $
 *
 * $Log: board_cfg.c,v $
 * Revision 1.3  2015-02-27 13:22:10  mgostling
 * Return hex string for USM board number and removed utoa()
 *
 * Revision 1.2  2015-02-25 17:54:42  hchalla
 * Added VME driver info for new CUTE testing.
 *
...
UINT32 brdCheckVMEBridgePresent (void *ptr)
{
	...
	reg = ((UINT8) dIoReadReg(0x22D, REG_8));
	*((UINT8*)ptr) = reg & 0x01;
