...
/* Version control:
 *
 * $Header: /home/cvs/cvsroot/CCT_BIT_2/board/vp91x.01x/pci.c,v 1.2 2015-02-06 15:27:43 mgostling Exp $
 *
 * $Log: pci.c,v $
 * Revision 1.2  2015-02-06 15:27:43  mgostling
 * Fixed table entries for optional XMC card presence for PCI Width test.
 * Force selection of table with onboard 82580 Ethernet controller.
 *
  ...
  #define PCIBr_ERROR					0x220
	...
	pci_Device	MDevices_0_1C_0[]= {
							{"Panther Point PCI Express Root Port 5 ", PCI_BRIDGE|PCI_EXPRESS, PCI_SINGLE_FUNC, 
									...
									NULL, RP5_ERROR, NULL},
							{"Panther Point PCI Express Root Port 7", PCI_BRIDGE|PCI_EXPRESS, PCI_SINGLE_FUNC, 
...
pci_Device	MDevices_0_1C_0_NoEth[]= {
							{"Panther Point PCI Express Root Port 5 ", PCI_BRIDGE|PCI_OPTIONAL|PCI_EXPRESS, PCI_SINGLE_FUNC, 
									0x8086, 0x1E18, 0x1C, 4, 0x00, 
									IntrRegs, {0x00,0x00,0x00}, NULL, NULL, 
									NULL, RP5_ERROR, NULL},
							{"Panther Point PCI Express Root Port 7", PCI_BRIDGE|PCI_EXPRESS, PCI_SINGLE_FUNC, 
	...
	pci_Device	MDevices_0_1_0[]= {							
							{"Ivy Bridge PCI Express Root Port 2nd Function", PCI_BRIDGE|PCI_EXPRESS|PCI_OPTIONAL| PXMC_PARENT, PCI_MULTI_FUNC|PXMC_XMC2|PXMC_OPTIONAL, 
	...
	pci_Device	pciDevices0[]= {
								...
								{"Ivy Bridge PCI Express Root Port-1", PCI_BRIDGE|PCI_EXPRESS| PXMC_PARENT, PCI_MULTI_FUNC|PXMC_XMC1|PXMC_OPTIONAL, 
	...
	pci_Device	pciDevices0_NoEth[]= {
								...
								{"Ivy Bridge Graphics Controller", PCI_DEVICE, PCI_SINGLE_FUNC, 
									...
									IntrRegs, {0x00,0x00,0x00}, NULL, NULL, 
									NULL, IGD0_ERROR, NULL},
//								{"Dynamic Platform and Thermal Framework[optional]", PCI_DEVICE|PCI_OPTIONAL, PCI_SINGLE_FUNC, 
								{"Unknown Optional Device", PCI_DEVICE|PCI_OPTIONAL, PCI_SINGLE_FUNC, 
									0x8086, 0x0153, 4, 0, 0x00, 
									PlaneRegs, {0x00,0x00,0x00}, NULL, NULL, 
									NULL, OPTDEV_ERROR, NULL},
								...
								{"Panther Point PCI Express Root Port 1", PCI_BRIDGE|PCI_EXPRESS, PCI_MULTI_FUNC, 
									0x8086, 0x1E10, 0x1C, 0, 0x00, 
									IntrRegs, {0x00,0x00,0x00}, MDevices_0_1C_0_NoEth, BDevices_0_1C_0, 
									NULL, RP1_ERROR, NULL},
								{"Panther Point USB Enhanced Host Controller #1", PCI_DEVICE, PCI_SINGLE_FUNC, 
									0x8086, 0x1E26, 0x1D, 0, 0x00, 
									IntrRegs, {0x00,0x00,0x00}, NULL, NULL, 
...
pci_DB brdPCIDB1 = { 0x00, brdChkPXMC, NULL, brdChkPeripheral, pciDevices0_NoEth, PCI_ERROR_BASE};
...
UINT32 brdGetPCIDB(void *ptr)
{
	...
	UINT8	check;
	if (board_service(SERVICE__BRD_CHECK_ETH_PRESENCE, NULL, &check) != E__OK)
	{
		sysDebugWriteString ("check 82580 returned NULL.\n");
		return E__FAIL;
	}

#ifdef DEBUG
	sprintf (achBuffer, "BRD Check: 0x%x",check);
