...
/* Version control:
 *
 * $Header: /home/cvs/cvsroot/CCT_BIT_2/board/amc1x.msd/services.h,v 1.3 2014-11-10 09:37:41 mgostling Exp $
 * $Log: services.h,v $
 * Revision 1.3  2014-11-10 09:37:41  mgostling
 * Add new service to verify RTC has reset properly and resolve issue if not.
 *
 * Revision 1.2  2014-10-09 09:48:08  chippisley
 * Added brdCheckSRIOMaster prototype.
 *
...
extern UINT32 brdGetSRIOInfo				(void *ptr);
extern UINT32 brdConfigSrioDevice			(void *ptr);
extern UINT32 brdDeConfigSrioDevice			(void *ptr);
extern UINT32 brdConfigSrioDevice2			(void *ptr);
extern UINT32 brdDeConfigSrioDevice2		(void *ptr);
extern UINT32 brdGetSlotId					(void *ptr);
extern UINT32 brdSelectSpiFwh				(void *ptr);
extern UINT32 brdGetFlashDriveParams		(void *ptr);
extern UINT32 brdCheckDualSrio				(void *ptr);
extern UINT32 brdCheckSRIOMaster			(void *ptr);
extern UINT32 brdInitRtc					(void *ptr);
