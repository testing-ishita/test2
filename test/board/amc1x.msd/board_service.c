...
/* Version control:
 *
 * $Header: /home/cvs/cvsroot/CCT_BIT_2/board/amc1x.msd/board_service.c,v 1.4 2014-11-10 09:34:24 mgostling Exp $
 * $Log: board_service.c,v $
 * Revision 1.4  2014-11-10 09:34:24  mgostling
 * Add new service to verify RTC has reset properly and resolve issue if not.
 *
 * Revision 1.3  2014-10-09 09:47:39  chippisley
 * Added SERVICE__BRD_CHECK_SRIO_MASTER command.
 *
 * Revision 1.2  2014-10-03 14:41:56  chippisley
 * Corrected SERVICE__BRD_CONFIG_SRIO_DEVICE_2, was calling the wrong function.
 *
...
//	{SERVICE__BRD_GET_GPIO_INFO,				PF_CAST brdGetGPIOInfo			},
	...
	{SERVICE__BRD_ENABLE_SMIC_LPC_IOWINDOW,		PF_CAST brdEnableSmicLpcIoWindow},
//	{SERVICE__BRD_PCI_CFG_SKIP_IO_ALLOCATION,	PF_CAST brdSkipIOResourceAllocation},
	{SERVICE__BRD_CONFIG_SRIO_DEVICE,			PF_CAST brdConfigSrioDevice},
	{SERVICE__BRD_DECONFIG_SRIO_DEVICE,			PF_CAST brdDeConfigSrioDevice},
    {SERVICE__BRD_CONFIG_SRIO_DEVICE_2,         PF_CAST brdConfigSrioDevice2},
    {SERVICE__BRD_DECONFIG_SRIO_DEVICE_2,       PF_CAST brdDeConfigSrioDevice2},
	{SERVICE__BRD_GET_SLOT_ID,					PF_CAST brdGetSlotId},
    {SERVICE__BRD_CHECK_DUAL_SRIO,              PF_CAST brdCheckDualSrio},
	{SERVICE__BRD_SELECT_SPI_FWH,				PF_CAST brdSelectSpiFwh},
	{SERVICE__BRD_GET_SRIO_INFO,				PF_CAST brdGetSRIOInfo},
	{SERVICE__BRD_GET_FLASH_DRV_PARAMS,			PF_CAST brdGetFlashDriveParams},
	{SERVICE__BRD_CHECK_SRIO_MASTER,			PF_CAST brdCheckSRIOMaster},
	{SERVICE__BRD_INIT_RTC,						PF_CAST brdInitRtc},
