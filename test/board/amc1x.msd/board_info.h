...
/* Version control:
 *
 * $Header: /home/cvs/cvsroot/CCT_BIT_2/board/amc1x.msd/board_info.h,v 1.1 2014-09-19 10:41:42 mgostling Exp $
 *
 * $Log: board_info.h,v $
 * Revision 1.1  2014-09-19 10:41:42  mgostling
 * Initial check in to CVS
 *
 * Revision 1.3  2014-08-04 15:12:46  mgostling
 * Corrected compiler warnings.
 *
 * Revision 1.2  2014-02-14 11:28:15  chippisley
...
#define AM9XX_MEMORY_TOP 					0xFFFFFFFF
#define AM9XX_CUTE_START 					0x2FFFFF
#define MEMORY_TOP 						AM9XX_MEMORY_TOP
#define CUTE_START 							AM9XX_CUTE_START
...
#define AM9XX_THRESHOLDS_SIZE 				8
#define AM9XX_TOTAL_THRESHOLDS_SIZE 		16
#define THRESHOLDS_SIZE 					AM9XX_THRESHOLDS_SIZE
#define TOTAL_THRESHOLDS_SIZE 				AM9XX_TOTAL_THRESHOLDS_SIZE
...
{
	char   signature[16];	// - This field will contain the string "CUTE_CONFIGINFO\0"
...
{
	char  signature[16];	// - This field will contain the string "CUTE_BIOS_INFO_\0"
	UINT32 Struct_ver;		// - 8bits Major, 8 bits minor, indicates structure version,
							//   this can be used to differentiate between different future versions
