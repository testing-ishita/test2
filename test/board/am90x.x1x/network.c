...
* $Revision: 1.1 $
*
* $Date: 2015-01-21 17:51:23 $
*
* $Source: /home/cvs/cvsroot/CCT_BIT_2/board/am90x.x1x/network.c,v $
*
...
void networkInit( void )
{
	...
	if( brdMode == 1  )
	{
		...
		ethDevParms.devices[2].did = 0x1502;	/* 82579LM */
		ethDevParms.devices[2].irqNo = 20;
		...
		ethDevParms.devices[3].did = 0x10D3;	/* 82574L */
