...
//#endif
    ...
    {SERVICE__BRD_GET_DRAM_SIZE_FROM_GPIO,	PF_CAST brdMemfromGPIO			},
...
//    {SERVICE__BRD_SKIP_ETH_TEST,	 	    PF_CAST brdSkipEthTest       	},
    ...
    {SERVICE__BRD_CONFIG_SRIO_DEVICE_2,PF_CAST brdDeConfigSrioDevice2},
