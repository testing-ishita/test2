...
/* Version control:
 *
 * $Header: /home/cvs/cvsroot/CCT_BIT_2/board/am94x.x1x/pci1.c,v 1.2 2014-03-06 13:29:05 hchalla Exp $
 *
 * $Log: pci1.c,v $
 ...
 *
 * Revision 1.2  2012/12/03 11:12:58  harithakns
 * Added support for REVB TF with X130 as NT
 *
  ...
  #define PCIBr_ERROR					0x220
	...
	pci_Device	BDevices_3_0_0[]= {
									{"IDT Switch ", PCI_BRIDGE|PCI_DEVICE|PCI_EXPRESS|PCI_EXPRESS_END|PCI_OPTIONAL, PCI_MULTI_FUNC,
										...
										IntrRegs, {0x00,0x00,0x00}, NULL, BDevices_4_1_0,NULL, PI7C9X_ERROR, NULL},

									{"IDT Switch ", PCI_BRIDGE|PCI_DEVICE|PCI_EXPRESS|PCI_EXPRESS_END|PCI_OPTIONAL, PCI_SINGLE_FUNC,
										0x111D, 0x808F, 2, 0, 0x00,IntrRegs, {0x00,0x00,0x00}, NULL, NULL,NULL, PI7C9X_ERROR, NULL},
									{"IDT Switch ", PCI_BRIDGE|PCI_DEVICE|PCI_EXPRESS|PCI_EXPRESS_END|PCI_OPTIONAL, PCI_SINGLE_FUNC,
	...
	pci_Device PCIE0BDevices[]= {{"PCIe to SRIO Bridge 0", PCI_DEVICE | PCI_EXPRESS  | PCI_EXPRESS_END,
									  PCI_MULTI_FUNC, 0x111d, 0x80ab, 0, 0, 0x00, IDTRegs, {0x00,0x00,0x00},
									  (void*)PES32MDevices, NULL, NULL, IDT_ERROR, NULL},
	...
	pci_Device	pciDevices0[]= {
								...
								{"Panther Point PCI Express Root Port 1", PCI_BRIDGE|PCI_EXPRESS, PCI_MULTI_FUNC,
									...
									IntrRegs, {0x00,0x00,0x00}, MDevices_0_1C_0, BDevices_0_1C_0,NULL,
									NULL, RP1_ERROR, NULL},
