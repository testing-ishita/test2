	...
	pci_Device pciDevices0[] = {
		...
		{"DRAM Controller [Arrandale]", PCI_DEVICE, PCI_SINGLE_FUNC, 0x8086, 0x0044,
								...
								{"PCI EXPRESS Root Port 0 [Lynx Point]", PCI_BRIDGE | PCI_EXPRESS,
								 PCI_MULTI_FUNC, 0x8086, 0x8c14/*0x8c10*/, 28, 0, 0, RP0Regs,
								 {0x00,0x00,0x00}, NULL /*(void*)RP1MDevices*/, NULL /*(void*)PEP11Devices*/,
								 NULL, RP1_ERROR, NULL},
								...
								{"LPC Interface [Lynx Point]", PCI_DEVICE,
								 ...
								 {0x00,0x00,0x00}, NULL /*(void*)LPCDevices*/, NULL, NULL, LPC_ERROR, NULL },

								{"SMBUS Controller [Lynx Point]", PCI_DEVICE,
								 PCI_MULTI_FUNC, 0x8086, 0x8c22, 31, 3, 0, LPCRegs,
								 {0x00,0x00,0x00}, NULL /*(void*)LPCDevices*/, NULL, NULL, LPC_ERROR, NULL },
