 ...
 */
static void prvCheckPendingReadyList( portSHORT cpuNo );
 ...
 */
static void prvCheckDelayedList( portSHORT cpuNo );
...
void vCoRoutineSchedule( void )
{
	...
	prvCheckPendingReadyList( cpuNo );

	/* See if any delayed co-routines have timed out. */
	prvCheckDelayedList( cpuNo );
