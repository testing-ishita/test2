...
/* Version control:
 *
 * $Header: /home/cvs/cvsroot/CCT_BIT_2/board/vre1x.msd/board_service.c,v 1.9 2014-08-04 08:47:42 mgostling Exp $
 *
 ...
 *
 * Revision 1.8  2014-07-29 11:39:29  mgostling
 ...
 *
 * Revision 1.7  2014-07-24 14:23:47  mgostling
 * Added SERVICE__BRD_GET_SLOT_ID entry to serviceCommands table.
 *
 * Revision 1.6  2014-03-28 15:28:21  cdobson
 * Added board service to get PCI device interrupt information.
 *
 * Revision 1.5  2014-03-27 11:56:46  mgostling
 * Added a new test to vefify XMC differention IO signals.
 *
 * Revision 1.4  2014-03-21 13:27:00  mgostling
 * Removed brdConfigureVPXNTPorts as the VPX backplane connections are tested with a new test.
 *
 * Revision 1.3  2014-03-20 16:02:18  mgostling
 * Add new service to get switch connections for ADVR3 loopback test
 *
 * Revision 1.2  2014-03-06 16:34:32  cdobson
...
const SERVICE_TYPE	serviceCommands[] =
{
	...
	{SERVICE__BRD_GET_HDA_LIST, 			PF_CAST brdGetHdaList			},
	{SERVICE__BRD_GET_RTM_PCIE_SWITCH_INFO,	PF_CAST brdGetRtmPex8733		},
	{SERVICE__BRD_GET_ENXMC_GPIO_INFO,		PF_CAST brdGetXmcGpioInfo		},
	{SERVICE__BRD_GET_PCI_INT_INFO,         PF_CAST brdGetPciInterruptInfo  },
