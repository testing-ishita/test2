...
* $Revision: 1.2 $
*
* $Date: 2015-03-10 15:05:31 $
*
* $Source: /home/cvs/cvsroot/CCT_BIT_2/board/vp91x.01x/network.c,v $
*
...
void networkInit( void )
{
	...
	ethDevParms.devices[0].did = 0x1502;	// 82579LM Copper
...
/*
	...
	ethDevParms.devices[1].did = 0x150E;	// 82580 Copper
	ethDevParms.devices[1].irqNo = 22;
	...
	ethDevParms.devices[2].did = 0x1510;	// 82580 SerDes
	ethDevParms.devices[2].irqNo = 21;
