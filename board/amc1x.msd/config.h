...
* $Revision: 1.3 $
*
* $Date: 2014-10-29 09:25:12 $
*
* $Source: /home/cvs/cvsroot/CCT_BIT_2/board/amc1x.msd/config.h,v $
*
...
#define MAX_CONFIG_CPUS	2	  			/* Set max configured CPU's, overriding detection */
								  		/* Set max configured CPU's, overriding detection */
								    	/* Set 0 to use number of logical CPU cores found */

//#define INCLUDE_AM94X_VARIANT_IPMI_WORKAROUND /* Workaround for Aeroflex AM 94x IPMI firmware bug */
