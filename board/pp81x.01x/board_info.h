...
/* Version control:
 *
 * $Header: /home/cvs/cvsroot/CCT_BIT_2/board/pp81x.01x/board_info.h,v 1.1 2013-09-04 07:13:49 chippisley Exp $
 *
 * $Log: board_info.h,v $
...
#define PP81X_MEMORY_TOP 					0xFFFFFFFF
#define PP81X_CUTE_START 					0x27FFFF

#define MEMORY_TOP 							PP81X_MEMORY_TOP
#define CUTE_START 							PP81X_CUTE_START
...
#define PP81X_THRESHOLDS_SIZE 				8
#define PP81X_TOTAL_THRESHOLDS_SIZE 		16
#define THRESHOLDS_SIZE 					PP81X_THRESHOLDS_SIZE
#define TOTAL_THRESHOLDS_SIZE 				PP81X_TOTAL_THRESHOLDS_SIZE
...
{
	UINT8  signature[16];	// - This filed will contain the string "CUTE_CONFIGINFO\0"
...
{
	UINT8  signature[16];	// - This filed will contain the string "CUTE_BIOS_INFO_\0"
	UINT32 Struct_ver;		// - 8bits Major, 8 bits minor, indicates structure version,
							//   this can be used to differentiate between different future versions
