...
/* Version control:
 *
 * $Header: /home/cvs/cvsroot/CCT_BIT_2/board/trb1x.msd/pci_cfg.c,v 1.2 2013-12-10 12:10:58 mgostling Exp $
 *
 * $Log: pci_cfg.c,v $
...
UINT32 brdPciGetParams (void *ptr)
{
	...
	sPciParams.bHostBridges		= 4;	// two in Haswell and two in LynxPoint
