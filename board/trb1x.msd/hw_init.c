...
/* Version control:
 *
 * $Header: /home/cvs/cvsroot/CCT_BIT_2/board/trb1x.msd/hw_init.c,v 1.3 2014-06-13 10:13:42 mgostling Exp $
 *
 * $Log: hw_init.c,v $
 * Revision 1.3  2014-06-13 10:13:42  mgostling
 * Add support for using INCLUDE_DEBUG_VGA
 *
...
UINT32 brdHwInit (void *ptr)
{
	...
	dTemp |= 0x00BA0000;										// turn off unused PCIe Bridges
	...
	/* Disable KT, IDE-R and all MEI interfaces, leave Display Bus (BDF) enabled */
	dTemp |= 0x0000001F;
#else
	/* Disable KT, IDE-R, all MEI interfaces and display bus */	
	dTemp |= 0x0000001E;
#endif
