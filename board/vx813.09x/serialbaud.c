...
UINT32 vEnRS485_hd(void *ptr)
{
	...
	vIoWriteReg(0x215, REG_8, 0x0); /* Interface disabled */
	vIoWriteReg(0x215, REG_8, 0xC0); /* Half Duplex RS485 */
...
UINT32 vEnRS485_fd(void *ptr)
{
	...
	vIoWriteReg(0x215, REG_8, 0x0); /* Interface disabled */
	vIoWriteReg(0x215, REG_8, 0x80); /* Full Duplex RS485 */
...
UINT32 vDisRS485(void *ptr)
{
	...
	vIoWriteReg(0x215, REG_8, 0x0); /* Interface disabled */
	vIoWriteReg(0x215, REG_8, 0x10); /* RS232 mode */
