...
* $Revision: 1.1 $
*
* $Date: 2014-05-15 09:42:03 $
*
* $Source: /home/cvs/cvsroot/CCT_BIT_2/board/vx91x.01x/config.h,v $
*
...
#undef INCLUDE_NETWORK					/* define to include networking */
#undef INCLUDE_LWIP_COMMAND_SERVER 		/* define to include LWIP command server */
#undef INCLUDE_LWIP_SMC 				/* define to include LWIP Soak Master client */
