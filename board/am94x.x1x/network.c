...
* $Revision: 1.3 $
*
* $Date: 2014-09-19 09:26:04 $
*
* $Source: /home/cvs/cvsroot/CCT_BIT_2/board/am94x.x1x/network.c,v $
*
...
void networkInit( void )
{
	...
	ethDevParms.devices[0].did = 0x1510;	/* 82580 SERDES */
	ethDevParms.devices[0].irqNo = 16;
	ethDevParms.devices[0].instance = 1;
	IP4_ADDR((&ethDevParms.devices[0].ipAddr), 192,67,84,249);
	...
	ethDevParms.devices[1].did = 0x1510;	/* 82580 SERDES */
	...
	ethDevParms.devices[2].did = 0x150e;	/* 82580 Copper */
	ethDevParms.devices[2].irqNo = 18;
	ethDevParms.devices[2].instance = 1;
	IP4_ADDR((&ethDevParms.devices[2].ipAddr), 192,67,84,244);
	...
	ethDevParms.devices[3].did = 0x150e;	/* 82580 Copper */
	ethDevParms.devices[3].irqNo = 19;
	ethDevParms.devices[3].instance = 2;
	IP4_ADDR((&ethDevParms.devices[3].ipAddr), 192,67,84,248);
