...
/* Version control:
 *
 * $Header: /home/cvs/cvsroot/CCT_BIT_2/board/am94x.x1x/hw_init.c,v 1.7 2014-09-19 09:14:23 mgostling Exp $
 *
 * $Log: hw_init.c,v $
 * Revision 1.7  2014-09-19 09:14:23  mgostling
 * Add support for two TSI721 SRIO devices
 *
 * Revision 1.2.2.1  2014-06-04 15:43:05  hchalla
 * Added support for dual SRIO chip and its root pcie port enable for second srio.
 *
 * Revision 1.6  2014-08-05 14:19:14  mgostling
 * Corrected compiler warnings.
 *
 * Revision 1.5  2014-08-05 13:54:33  mgostling
 * no message
 *
 ...
 *
 * Revision 1.1  2014-01-29 14:06:32  hchalla
...
UINT32 brdHwInit (void *ptr)
{
	...
	if (wAcpiBase != 0)
	{
       ...
       //(R) PCI Config. 80h: 3F030010 000C0211 007C0601 000C0311
       //(R) PCI Config. 90h: 007C0C81 00000F00 00000000 00000000
	//(R) PCI Config. 80h: 3F030010 000C0211 007C0601 000C0311
	//(R) PCI Config. 90h: 00FC0CA1 00000F00 00000000 00000000
	
	pfa = PCI_MAKE_PFA(0,31,0);
	PCI_WRITE_DWORD(pfa,0x80,0x3f030010);	/* I/O decode range */
	PCI_WRITE_DWORD(pfa,0x88,0x00C0211);	/* LPC I/F Generic Decode Range 2 */
	PCI_WRITE_DWORD(pfa,0x8C,0x007C0601);	/* LPC I/F Generic Decode Range 3 */
	PCI_WRITE_DWORD(pfa,0x90,0x00FC0CA1);	/* LPC I/F Generic Decode Range 4 */
	PCI_WRITE_DWORD(pfa,0x94,0x00000F00);	/* LPC I/F Generic Decode Range 4 */
	...
	mHandle = dGetPhysPtr(Addr,0x4000,&tPtr1,(void*)&mapRegSpace);
	 ...
	 osWriteDWord((mapRegSpace+0x3418), 0x1dea1ff2); //working
	 //osWriteDWord((mapRegSpace+0x3418), 0x1DE81FF2); //Hari:19/05/2014

	 //osWriteDWord((mapRegSpace+0x3418), 0x1dea1ff0); 
