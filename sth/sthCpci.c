...
/* Version control:
 *
 * $Header: /home/cvs/cvsroot/CCT_BIT_2/sth/sthCpci.c,v 1.8 2015-04-01 16:47:27 hchalla Exp $
 * $Log: sthCpci.c,v $
 * Revision 1.8  2015-04-01 16:47:27  hchalla
 * Fixed problem with test parameters passing from STH.
 *
 * Revision 1.7  2014-08-04 10:35:25  mgostling
 * Fix compiler warning.
 *
 * Revision 1.6  2014-01-29 13:33:36  hchalla
 * Added debug prints for debugging SOAK.
 *
 * Revision 1.5  2013-10-11 09:07:14  chippisley
 * Added conditional define around declaration of vSthSetBoardInfo(),
 * vSthSlaveInfo() and vSthAssignSlaveAddr().
 *
 * Revision 1.4  2013/10/08 07:11:59  chippisley
 * Updates for Cygwin 1.7.25 GCC 4.7.3-1, fixed various compiler warnings.
 *
 * Revision 1.3  2013/09/27 16:05:53  chippisley
 * Modified to assign the board address based slot ID, when handling a slave
 ...
 * 
 * Revision 1.7  2012/09/14 15:38:45  jthiru
 * CUTE Support for VX91X - C5043B1110, fixes to existing bugs
 *
 * Revision 1.6  2012/02/17 11:33:52  hchalla
 ...
 * CA01A151
 *
 * Revision 1.3  2010/11/04 17:44:58  hchalla
 * Added support for CPCI backplane for pericom bridge and debug info.
 *
...
static UINT8 bCpciAddrToSlot (UINT16 wAddr);
...
*/	
		...
		if (psPkt->hdr.wDestID != my_slot)
		{
			...
			bSlot = bCpciAddrToSlot (psPkt->hdr.wDestID);
